      ...
      <div className="mx-[32px] my-[20px]">
        ...
        <div className="w-[61vw] mt-[40px] mb-[20px] position: relative left-[180px]">
          <div className="flex justify-between ">
            <p className="text-[22px] text-[#DDDDE4] font-[700]">배움일기</p>
            <NavLink to="/diaryadd">
              <button className="bg-[#5F9DFA] text-white text-[12px] font-[900] px-[15px] py-[11px] rounded-2xl cursor-pointer">
                배움일기 작성하기
              </button>{" "}
            </NavLink>
          </div>
          ...
          <div className="flex justify-between">
            <div className="flex border-1 border-gray-700 my-[10px] w-[15vw] rounded-[7px]">
              ...
              <input
                className="text-gray-100 font-[700] text-[12px] w-[10vw] outline-none"
                placeholder="키워드나 멤버 및 그룹으로 검색"
              />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-x-[20px] gap-y-[20px] mt-[20px]">
            <DiaryCard />
          </div>
        </div>
      </div>
