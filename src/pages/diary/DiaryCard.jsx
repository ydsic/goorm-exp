...
export default function DiaryCard() {
  const card_style = {
    ...
    title: `text-[#DDDDE4] text-[15px] font-[600] mx-[20px] my-[15px] visited:text-[#DDDDE4]`,
    subtitle: `text-[#9395A4] text-[14px] font-[500] mx-[20px] h-[6vh] visited:text=[#9395A4] truncate overflow-hidden whitespace-nowrap`,
      ...
      {DiaryData.map((data, index) => (
        <NavLink key={index} to={`/diarypage/${index}`}>
          <div className={card_style.card}>
            <div className={card_style.title}>{data.title}</div>
            <div className={card_style.subtitle}>{data.subtitle}</div>
            ...
            <div className={`${card_style.flex} ${card_style.justify_between}`}>
              <div className={card_style.flex}>
                <div className={`${card_style.flex} ${card_style.margin}`}>
                  ...
                  <p className={card_style.footer_icon}>{data.heart}</p>
                ...
                <div className="flex my-[15px] ml-[10px]">
                  ...
                  <p className={card_style.footer_icon}>{data.comment}</p>
                </div>
              </div>
